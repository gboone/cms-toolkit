...
function cfpb_build_plugin() 
{
    ...
    include_once CFPB_INC . 'meta-box-models.php';
    include_once CFPB_INC . 'meta-box-callbacks.php';
    include_once CFPB_INC . 'meta-box-view.php';
    include_once CFPB_INC . 'meta-box-html.php';
    include_once CFPB_INC . 'capabilities.php';
    include_once CFPB_INC . 'post-types.php';
    include_once CFPB_INC . 'taxonomies.php';
